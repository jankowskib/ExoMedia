...
class VideoControlsLeanback : VideoControls {
    ...
    override fun animateVisibility(toVisible: Boolean) {
        ...
        if (!isLoading) {
            controlsParent.startAnimation(BottomViewHideShowAnimation(controlsParent, toVisible, VideoControls.CONTROL_VISIBILITY_ANIMATION_LENGTH))
        }
    ...
    override fun updateTextContainerVisibility() {
        ...
        if (hideEmptyTextContainer && emptyText && textContainer.visibility == View.VISIBLE) {
            ...
            textContainer.startAnimation(BottomViewHideShowAnimation(textContainer, false, VideoControls.CONTROL_VISIBILITY_ANIMATION_LENGTH))
        } else if ((!hideEmptyTextContainer || !emptyText) && textContainer.visibility != View.VISIBLE) {
            textContainer.clearAnimation()
            textContainer.startAnimation(BottomViewHideShowAnimation(textContainer, true, VideoControls.CONTROL_VISIBILITY_ANIMATION_LENGTH))
        }
    }
